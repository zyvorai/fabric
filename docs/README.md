...
| **Service Fabric v5** (Maglev VIP LB + HA deltas) | [ebpf-service-fabric.md](ebpf-service-fabric.md) · [examples](examples/service-fabric-v3/) · [phase 5](service-fabric-phase5.md) · [phase 6](service-fabric-phase6.md) |
