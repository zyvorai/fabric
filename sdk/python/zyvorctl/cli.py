...
from .client import ZyvorFabricClient
...
def main():
    ...
    parser.add_argument(
        ...
        help="zyvor-fabricd API URL (default: http://127.0.0.1:8080)",
    )
    ...
    client = ZyvorFabricClient(args.url, args.token)
    fmt = args.output
...
def _dispatch(client: ZyvorFabricClient, args) -> object:
