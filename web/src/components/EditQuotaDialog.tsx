...
import { updateQuota, ResourceQuota } from '../api/quota'
...
export default function EditQuotaDialog({ quota, onClose, onSuccess }: EditQuotaDialogProps) {
      ...
      <div className="bg-gray-800 rounded-lg shadow-2xl border border-gray-700 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-700 sticky top-0 bg-gray-800 z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold">Edit Resource Quota</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                required
              />
              {formData.max_cpus < quota.used_cpus && (
            ...
            <div>
              ...
              {formData.max_memory < quota.used_memory && (
                <p className="text-xs text-red-400 mt-1">
            ...
            <div>
              ...
              <input
                ...
                required
              />
              {formData.max_disk < quota.used_disk && (
                <p className="text-xs text-red-400 mt-1">
            ...
            <div>
              ...
              <input
                ...
                required
              />
              {formData.max_vms < quota.used_vms && (
                <p className="text-xs text-red-400 mt-1">
