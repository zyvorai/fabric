    ...
    <ModalWrapper title="Create Macvtap" onClose={onClose}>
      <div className="space-y-4">
        ...
        <div>
          ...
          <select value={mode} onChange={e => setMode(e.target.value as MacvtapMode)} className="w-full bg-gray-800 border border-gray-800 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-blue-500">
