...
DOCUMENTATION = r'''
---
module: vmspawnd_datacenter
short_description: Manage datacenters and clusters in vmspawnd
description:
    - Create and delete datacenters and clusters managed by vmspawnd.
...
class VmspawndAPI:
    """Minimal API wrapper for vmspawnd datacenter/cluster endpoints."""
