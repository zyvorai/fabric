...
async fn main() -> Result<()> {
    ...
    // Logs go to /tmp/zyvorctl-tui.log when ZYVOR_FABRICD_LOG_LEVEL=debug
    ...
    let log_file = tracing_appender::rolling::never("/tmp", "zyvorctl-tui.log");
    ...
    tracing::debug!("zyvorctl-tui starting");
    ...
    tracing::debug!("zyvorctl-tui shutdown complete");
    Ok(())
}
