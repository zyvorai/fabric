...
//! `ConsoleDriver` backed by FluxVM's `GET /v1/vms/{id}/console`
//! WebSocket (`FluxVmClient::open_console`), itself backed by the vsock
...
#[async_trait]
impl ConsoleDriver for FluxVmDriver {
