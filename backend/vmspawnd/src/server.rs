...
impl Server {
    ...
    pub async fn run(self) -> Result<()> {
        ...
        let api_routes = Router::new()
            ...
            // SDN networking routes
            .route("/network/switches", get(api::network::list_switches).post(api::network::create_switch))
            .route("/network/switches/:id", get(api::network::get_switch).delete(api::network::delete_switch))
            .route("/network/port-groups", get(api::network::list_port_groups).post(api::network::create_port_group))
            .route("/network/port-groups/:id", put(api::network::update_port_group).delete(api::network::delete_port_group))
            .route("/network/firewall/sections", get(api::network::list_firewall_sections).post(api::network::create_firewall_section))
            .route("/network/firewall/rules", get(api::network::list_firewall_rules).post(api::network::create_firewall_rule))
            .route("/network/firewall/rules/:id", get(api::network::get_firewall_rule).put(api::network::update_firewall_rule).delete(api::network::delete_firewall_rule))
            .route("/network/security-groups", get(api::network::list_security_groups).post(api::network::create_security_group))
            .route("/network/overlays", get(api::network::list_overlays).post(api::network::create_overlay))
            .route("/network/overlays/:id", get(api::network::get_overlay).delete(api::network::delete_overlay))
            .route("/network/load-balancers", get(api::network::list_load_balancers).post(api::network::create_load_balancer))
            .route("/network/load-balancers/:id", get(api::network::get_load_balancer).delete(api::network::delete_load_balancer))
