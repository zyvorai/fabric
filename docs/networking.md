...
| Cluster REST | `/api/dataplane/{groups,cnp,identities,observe,health,ipcache,refresh-dns}` + `/api/dataplane/services…` (Service Fabric v5) |
...
| Maglev VIP LB | [Service Fabric v5 (BPF schema 4)](ebpf-service-fabric.md) · Edge Dataplane → **Services** |
