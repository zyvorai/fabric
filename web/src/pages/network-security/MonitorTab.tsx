        ...
        <div className="border border-gray-800 rounded-lg p-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <select value={thMetric} onChange={e => setThMetric(e.target.value)} className="w-full bg-gray-800 border border-gray-800 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-blue-500">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div>
              ...
              <select value={thUnit} onChange={e => setThUnit(e.target.value)} className="w-full bg-gray-800 border border-gray-800 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-blue-500">
            ...
            <div>
              ...
              <select value={thDirection} onChange={e => setThDirection(e.target.value as MetricDirection)} className="w-full bg-gray-800 border border-gray-800 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-blue-500">
            ...
            <div>
              ...
              <select value={thSeverity} onChange={e => setThSeverity(e.target.value as AlertSeverity)} className="w-full bg-gray-800 border border-gray-800 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-blue-500">
