...
read the summary, keep a history, read an email from your browser tab on click, take spoken commands, and approve actions with your fingerprint. It is a **client**: it sends files to a Keep host you run
...
Sources/Solvor/         the SwiftUI app: use cases, runs, approvals, watch folders, settings, menu bar,
...
xcodebuild -project Solvor.xcodeproj -scheme Solvor -destination 'platform=macOS' test
```
