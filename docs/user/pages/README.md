...
| [Edge Dataplane](infrastructure/edge-dataplane.md) | Edge Dataplane — Maglev Services (Service Fabric v5) plus groups, CNP, identities, observe, health, ipcache (`/app/edge-dataplane`). |
