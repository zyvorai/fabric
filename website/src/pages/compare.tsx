  ...
  return (
    <header className={styles.hero} ref={ref}>
      ...
      <div className={styles.heroInner}>
        <p className={clsx(styles.heroEyebrow, styles.rise)}>Muse · Keep · Fabric · FluxVM</p>
        <Heading as="h1" className={clsx(styles.heroTitle, styles.rise, styles.rise2)}>
          Muse proved the idea.
          <br />
          <span className={styles.heroAccent}>You keep the keys.</span>
        </Heading>
        <p className={clsx(styles.heroSub, styles.rise, styles.rise3)}>
          One closed agent cloud, and three open layers you run yourself: Keep for policy, Fabric
          for control, FluxVM for the cell and the network pin.
        </p>
      ...
      <a className={styles.scrollCue} href="#stack" aria-label="Scroll to the stack">
        <span />
      </a>
    </header>
  );
