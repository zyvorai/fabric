...
| [Edge Dataplane](infrastructure/edge-dataplane.md) | Edge Dataplane — Maglev Services (schema v3) plus groups, CNP, identities, observe, health, ipcache (`/app/edge-dataplane`). |
