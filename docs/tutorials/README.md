...
| 16 | [Keep workstation](16-keep-workstation.md) | Intermediate | 45 min | Open agent workstation: policy YAML, keepctl, cockpit taint, export-token; CI without KVM. |

Deep-dive series (groups, CNP, observe, UX):
[edge-dataplane/](edge-dataplane/README.md).

**Keep** product docs: [docs/keep/KEEP.md](../keep/KEEP.md) · CI: [`.github/workflows/keep.yml`](../../.github/workflows/keep.yml).
