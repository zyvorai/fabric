...
| [Edge Dataplane](infrastructure/edge-dataplane.md) | Edge Dataplane — Maglev Services (schema v4) plus groups, CNP, identities, observe, health, ipcache (`/app/edge-dataplane`). |
