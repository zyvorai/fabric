...
| **Service Fabric schema v4** | Maglev VIP LB, NAT/DSR, affinity, health/drain, VIP ads, EDT, FluxScope, host-routing, FRR/BIRD/File | `/api/dataplane/services…` · Edge Dataplane → **Services** · [docs/ebpf-service-fabric.md](docs/ebpf-service-fabric.md) |
...
| **Service Fabric v4 (Maglev VIP LB)** | [docs/ebpf-service-fabric.md](docs/ebpf-service-fabric.md) |
