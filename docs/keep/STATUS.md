...
| Keep 0.2 | **Soft scaffolding complete** (receipt, host-recover gate, screenshot/screencast, user-held + FluxVM capabilities, fabricd proxies, bake script); **hardware still gated** | [`KEEP-0.2.md`](KEEP-0.2.md) |
