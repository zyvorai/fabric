...
| [VM Dataplane](infrastructure/dataplane.md) | VM Dataplane — per-VM TC/eBPF edge (Network Fabric v3): Status / Policy / Stats / Flows on the VM detail tab; orthogonal to host SDN. |
