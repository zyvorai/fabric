  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button onClick={loadData} className="flex items-center gap-2 px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded-lg transition">
          ...
          <div className="space-y-3">
            {machines.length === 0 ? (
              ...
              <button key={m.name} onClick={() => selectMachine(m.name)}
                className={`w-full text-left p-4 rounded-lg border transition ${selectedMachine === m.name ? 'bg-blue-500/10 border-blue-500/30' : 'bg-gray-800 border-gray-700 hover:border-gray-600'}`}>
              ...
              <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
                ...
                <div className="flex gap-2 mb-3">
                  <input value={shellCmd} onChange={e => setShellCmd(e.target.value)}
                    ...
                    placeholder="Enter command..." className="flex-1 bg-gray-900 border border-gray-600 rounded px-3 py-2 font-mono text-sm focus:outline-none focus:border-blue-500" />
                ...
                {shellOutput && (
                  <div className="bg-gray-900 rounded p-3 font-mono text-xs max-h-64 overflow-auto">
                    ...
                    <div className="text-gray-500 mt-2 border-t border-gray-700 pt-1">exit code: {shellOutput.exit_code}</div>
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
            ...
            <div className="flex gap-2">
              ...
              <input value={pullName} onChange={e => setPullName(e.target.value)} placeholder="Name"
                className="w-48 bg-gray-700 border border-gray-600 rounded px-3 py-2 text-sm focus:outline-none focus:border-blue-500" />
