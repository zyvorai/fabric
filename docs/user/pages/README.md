...
| [VM Dataplane](infrastructure/dataplane.md) | VM Dataplane — per-VM TC/eBPF edge (Network Fabric schema v4): Status / Policy / Stats / Flows on the VM detail tab; orthogonal to host SDN. |
