...
function ServicesTabContent({ services, onDelete, onCreate, onSync }: ServicesTabProps) {
  return (
    <div className="bg-gray-900 rounded-lg border border-gray-800">
      ...
      {services.length === 0 ? (
        <div className="p-12 text-center text-gray-400">No services configured. Create one to define virtual IP load-balanced services.</div>
      ) : (
          ...
          <table className="w-full">
            <thead className="bg-gray-800">
              <tr>
                ...
                <th className="text-left p-4 font-medium text-gray-300">Algorithm</th>
                <th className="text-left p-4 font-medium text-gray-300">Backends</th>
