...
export default function Storage() {
  ...
  if (loading) {
    return <div className="text-center text-gray-400 py-12">Loading storage data...</div>
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-900 rounded-lg border border-gray-800">
        ...
        {pools.length === 0 ? (
          <div className="p-12 text-center text-gray-400">No storage pools configured. Create one from the Storage Pools page.</div>
        ) : (
                ...
                <div key={pool.id} className="bg-gray-800 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className={`text-sm font-medium ${pool.state === 'Active' ? 'text-green-400' : 'text-gray-400'}`}>
                        {pool.state}
                      </span>
                    </div>
                  </div>
                  <div className="mb-2">
                    <div className="flex items-center justify-between text-sm mb-1">
                      <span className="text-gray-400">{formatBytes(used)} / {formatBytes(pool.capacity)}</span>
      ...
      <div className="bg-gray-900 rounded-lg border border-gray-800">
        ...
        {volumes.length === 0 ? (
          <div className="p-12 text-center text-gray-400">No volumes found.</div>
        ) : (
              ...
              <tbody className="divide-y divide-gray-800">
                {volumes.map((volume) => (
                  <tr key={volume.id} className="hover:bg-white/[0.03] transition">
                    ...
                    <td className="p-4 text-gray-400">{volume.pool}</td>
