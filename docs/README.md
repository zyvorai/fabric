...
| **Service Fabric v4** (Maglev VIP LB) | [ebpf-service-fabric.md](ebpf-service-fabric.md) · [examples](examples/service-fabric-v3/) · [phase 4](service-fabric-phase4.md) · [phase 5](service-fabric-phase5.md) |
