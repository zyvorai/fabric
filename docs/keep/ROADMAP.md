...
3. **More file types** (done, except OCR): docx, xlsx, pptx, html, eml/mbox, zip fan-out, and regex / JSON-path / table rules. OCR needs tesseract baked into the cell template and is not built.
