...
Zones — Infrastructure surface for placement domains.
...
- Route / id: `/zones`
- Nav: **Infrastructure → Zones** (sidebar, command palette, or desktop nav)

## Operate from the console (UX)

1. Open `/zones` and wait for live data from Zyvor Fabric.
