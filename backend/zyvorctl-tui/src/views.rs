...
pub fn render_help(f: &mut Frame, area: Rect) {
    let help_text = vec![
        ...
        Line::from("  [1-7]       Switch views (Dashboard, VMs, Logs, Metrics, Network, NetSecurity, Storage)"),
        Line::from("  [↑/k]       Move up"),
        ...
        Line::from("  [:]         Enter command mode (then type command, Enter to run)"),
        Line::from("  :vms        Switch to VM list"),
        Line::from("  :dashboard  Switch to dashboard"),
        Line::from("  :start      Start selected VM"),
        Line::from("  :stop       Stop selected VM"),
        Line::from("  :snap       Snapshot selected VM"),
        Line::from("  :refresh    Refresh all data"),
